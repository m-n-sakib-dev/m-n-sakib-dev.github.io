...
export const skillGroups = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'WebSockets / Realtime', level: 74 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'RBAC & Permissions', level: 85 },
      { name: 'Multi-Tenant Architecture', level: 80 },
      { name: 'Tenant Data Isolation', level: 78 },
      { name: 'Audit / Activity Logging', level: 80 },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: '⇄',
    skills: [
      { name: 'Payment Gateways', level: 84 },
      { name: 'Courier / Logistics APIs', level: 82 },
      { name: 'SMS Gateways', level: 82 },
      { name: 'Transactional Email / SMTP', level: 80 },
      { name: 'Webhooks & Callback Verification', level: 80 },
      { name: 'Third-Party REST APIs', level: 84 },
    ],
  },
  {
    ...
    icon: '↻',
    skills: [
      { name: 'Queue Workers / Jobs', level: 84 },
      { name: 'Scheduled Jobs (Cron)', level: 82 },
      { name: 'Event / Observer Pattern', level: 78 },
      { name: 'Retry & Failure Handling', level: 78 },
      { name: 'Redis Queues', level: 76 },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Kubernetes (Autoscaling)', level: 68 },
      { name: 'DigitalOcean', level: 76 },
      { name: 'Linux / Ubuntu Server', level: 74 },
